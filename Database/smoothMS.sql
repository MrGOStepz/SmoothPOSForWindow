CREATE DATABASE  `smoothdb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE [smoothdb];
...
CREATE TABLE tb_cook_status (
  [cook_status_id] int NOT NULL IDENTITY,
...
CREATE INDEX [FK_level_employee] ON tb_employee ([level_id]);
CREATE INDEX [FK_status_employee] ON tb_employee ([status_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_employee_status (
  [tb_status_id] int NOT NULL IDENTITY,
...
CREATE TABLE tb_employee_time_sheet (
  [employee_time_sheet_id] int NOT NULL IDENTITY,
  [employee_id] int NOT NULL,
  [clockin_time] datetime2(0) DEFAULT NULL,
  [clockout_time] datetime2(0) DEFAULT NULL,
...
CREATE TABLE tb_ingredient (
  [ingredient_id] int NOT NULL IDENTITY,
...
CREATE TABLE tb_location_menu (
  [location_menu_id] int NOT NULL IDENTITY,
  [product_id] int DEFAULT NULL,
...
CREATE INDEX [FK_locationmenu_locationtab_idx] ON tb_location_menu ([location_tab_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_location_tab (
  [location_tab_id] int NOT NULL IDENTITY,
  [name] varchar(45) DEFAULT NULL,
...
CREATE TABLE tb_order (
  ...
  [order_at] datetime2(0) DEFAULT NULL,
...
CREATE INDEX [FK_orderstatus_order] ON tb_order ([order_status_id]);
CREATE INDEX [FK_ordertype_order] ON tb_order ([order_type_id]);
CREATE INDEX [FK_payment_order] ON tb_order ([payment_id]);
CREATE INDEX [FK_customer_order] ON tb_order ([customer_id]);
CREATE INDEX [FK_employy_order_idx] ON tb_order ([employee_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE INDEX [FK_product_orderdetail] ON tb_order_detail ([product_id]);
CREATE INDEX [FK_popupitem_orderdetail] ON tb_order_detail ([popup_item_id]);
CREATE INDEX [FK_order] ON tb_order_detail ([order_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_order_type (
  [tb_order_type_id] int NOT NULL IDENTITY,
  [name] varchar(45) NOT NULL,
...
CREATE TABLE tb_popup (
  [popup_id] int NOT NULL IDENTITY,
  [name] varchar(45) NOT NULL,
...
CREATE TABLE tb_popup_item (
  [popup_item_id] int NOT NULL IDENTITY,
  [name] varchar(45) DEFAULT NULL,
...
CREATE INDEX [FK_popup_popupitem] ON tb_popup_item ([popup_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_printer (
  [printer_id] int NOT NULL IDENTITY,
  [name] varchar(45) NOT NULL,
...
CREATE TABLE tb_printer_log (
  [printer_log_id] int NOT NULL IDENTITY,
  [printer_id] int NOT NULL,
  [print_dt] datetime2(0) NOT NULL,
...
CREATE INDEX [FK_printerlog_printer_idx] ON tb_printer_log ([printer_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_printer_product (
  [printer_product_id] int NOT NULL IDENTITY,
...
CREATE INDEX [FK_printer_printerproduct] ON tb_printer_product ([printer_id]);
CREATE INDEX [FK_product_printerproudct] ON tb_printer_product ([product_id]);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_table_section (
  [table_section_id] int NOT NULL IDENTITY,
  ...
  CONSTRAINT [u_name_UNIQUE] UNIQUE  ([u_name])
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE tb_type_food (
  [type_food_id] int NOT NULL IDENTITY,
  [name] varchar(255) NOT NULL,
